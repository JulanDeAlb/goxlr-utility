...
use cpal::{DefaultStreamConfigError, Device, SupportedStreamConfig};
...
impl CpalConfiguration {
    ...
    pub(crate) fn get_config(device: Device, input: bool) -> Result<SupportedStreamConfig, DefaultStreamConfigError> {
        return if input {
